...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="{{ asset('/import/dist/img/low.jpg')}}" class="img-circle elevation-2" alt=" Image">
        </div>
        <div class="info">
 ...
 <form action="{{route('doctors.store')}}" method="POST">
    @csrf 
    <div class="row"></div> // Add the missing closing tag for the <div class="row"> element
    ...
    <div class="row">
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>Doctor ID: </strong>
                    <input type="text" name="DoctorID" value="{{$doctor->DoctorID}}" class="form
control" placeholder="Doctor ID">
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>First Name: </strong>
                    <input type="text" name="Firstname" value="{{$doctor->Firstname}}" class="form
control" placeholder="First Name">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>Specialization: </strong>
                    <input type="text" name="Specialization" value="{{$doctor->Specialization}}" class="form-control" placeholder="Specialization">
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
          ...
          <div class="col-md-3">
              ...
              <div class="card-body box-profile">
                <div class="text-center">
                  <img class="profile-user-img img-fluid img-circle"
                       src="{{ asset('/import/dist/img/low.jpg')}}"
                       alt="User profile picture">
                </div>

                <h3 class="profile-username text-center">Adrian Putian</h3>

                <p class="text-muted text-center">Computer Science</p>
            ...
            <div class="card card-primary">
              ...
              <div class="card-body">
                ...
                <p class="text-muted">
                  B.S. in Computer Science from the University of Mindanao
                </p>
                ...
                <p class="text-muted">Davao, Philippines</p>
                ...
                <p class="text-muted">Aspiring Software Engineering</p>
              </div>
              <!-- /.card-body -->
            </div>
            <!-- /.card -->
