...
<div class="wrapper">
 ...
 <form action="{{route('patients.update',$patient->id)}}" method="POST">
    ...
    <div class="form-group">
            ...
            <input type="text" name="FirstName" value="{{$patient->FirstName}}" class="form
control" placeholder="FirstName">
    ...
    <div class="col-xs-12 col-sm-12 col-md-12">
        <div class="form-group">
            ...
            <input type="text" name="MiddleName" value="{{$patient->MiddleName}}"class="form
control" placeholder="Middle Name">
       </div>
    </div>
    <div class="col-xs-12 col-sm-12 col-md-12">
        <div class="form-group">
...
placeholder="Last Name">
    ...
    <div class="col-xs-12 col-sm-12 col-md-12">
        <div class="form-group">
            <strong>Sex: </strong>
            <input type="text" name="Sex" value="{{$patient->Sex}}" class="form-control" 
placeholder="Sex">
       </div>
    </div>
    <div class="col-xs-12 col-sm-12 col-md-12">
        <div class="form-group">
            ...
            <input type="text" name="BirthDate" value="{{$patient->BirthDate}}"class="form-control" 
